...
export function Deck(props: DeckProps) {
	...
	return <main className="flex-1 overflow-auto w-full">
		<div className="h-screen overflow-y-auto divide-y divide-gray-200 dark:divide-gray-700 flex">
			...
			<div onClick={addColumn} onKeyUp={addColumn} className="opacity-20 w-5 hover:w-[300px] group duration-100 ease-in-out transition-[width] flex items-center justify-center text-4xl text-gray-500 dark:text-gray-400 cursor-pointer bg-gray-300 hover:bg-gray-200 dark:bg-gray-700 dark:hover:bg-gray-600">
		...
		<Drawer open={Boolean(props.openDrawer)}><Outlet /></Drawer>
	</main>
