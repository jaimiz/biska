    ...
    <Sheet>
      ...
      >
        ...
        <SheetDescription>
          ...
          Passwords.
          Na nova página, você vai ver uma lista contendo suas App Passwords. Se
          você ainda não criou nenhuma, a lista estará vazia, como na imagem.
          Clique em 'Add App Password'.

          Na janela que se abre, você pode digitar um nome ou utilizar o nome
          aleatório que eles sugerem. É recomendável que você coloque um nome
          que te ajude a identificar onde aquela senha está sendo usada, caso
          você precise revogá-la. Digite o nome da sua preferência e clique em
          'Create App Password'
          ...
          local seguro, como um gerenciador de senhas.

          Pronto! Agora você pode usar essa 'App Password' para fazer login na
          Balloon Foundation.
